...
let storyHeroName = "Sergey"
let savedNumberOfDollars = 1000
let adjectiveDescriptionOfProduct = "gorgeous"
let nameOfProduct = "MacBook Air"
let nameOfProductStore = "Re:store"
let positiveEmotion = "☺️"
let negativeEmotion = "😖"
let sampleStory = "Today was a big day for \(storyHeroName). They had finally saved up \(savedNumberOfDollars) dollars and were going to buy a \(adjectiveDescriptionOfProduct) \(nameOfProduct). They went to the \(nameOfProductStore) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). They were all out of \(nameOfProduct)!"
/*:
