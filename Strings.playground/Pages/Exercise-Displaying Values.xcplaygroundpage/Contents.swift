 ...
 */
let megaBytesOnGygaBytes = 1000
let phoneCapacityMB = 8 * megaBytesOnGygaBytes
let phoneCapacityUsedMB = 3 * megaBytesOnGygaBytes
let minutOfVideoCapasity = 150

let howManyMinutesOfVideo = "You can record \((phoneCapacityMB - phoneCapacityUsedMB)/minutOfVideoCapasity) more minutes of video."
